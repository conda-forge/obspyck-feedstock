About obspyck-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/obspyck-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/megies/obspyck
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4954&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/obspyck-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `obspyck` can be installed with `conda`:
...
```
mamba install obspyck
```

It is possible to list all of the versions of `obspyck` available on your platform with `conda`:
...
```
mamba search obspyck --channel conda-forge
```
...
mamba repoquery search obspyck --channel conda-forge

# List packages depending on `obspyck`:
mamba repoquery whoneeds obspyck --channel conda-forge

# List dependencies of `obspyck`:
mamba repoquery depends obspyck --channel conda-forge
```
